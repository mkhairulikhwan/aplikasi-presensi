...
if (isset($_POST['submit'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($no_handphone)) {
            $pesan_kesalahan[] = "<i class='fa-solid fa-check'></i> No. HP wajib diisi";
        }
        if (empty($jabatan)) {
        ...
        if (!in_array(strtolower($ambil_ekstensi), $ekstensi_diizinkan)) {
            $pesan_kesalahan[] = "<i class='fa-solid fa-check'></i> Hanya file JPG, PNG, JPEg yang diperbolehkan";
        }
        if ($ukuran_file > $max_ukuran_file) {
            $pesan_kesalahan[] = "<i class='fa-solid fa-check'></i> Ukuran foto lebih dari 10Mb";
        }
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="lokasi_presensi">
                                    <option selected>Pilih Lokasi Presensi</option>
                                    <?php
                                    ...
                                    while ($lokasi = mysqli_fetch_assoc($ambil_lok_presensi)) {
                                        ...
                                        if (isset($_POST['lokasi_preses']) && $_POST['lokasi_presensi'] == $nama_lokasi) {
